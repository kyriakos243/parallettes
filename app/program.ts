...
const existing: ExerciseSeed[] = [
  ...
  { id: "shoulder-sweep", name: "Standing Shoulder Sweep", level: "ALL", category: "Warm-up", eligibleBlocks: ["warmup"], primaryFocus: "shoulder-mobility", secondaryFocus: ["line"], compatibleDays: "all", target: "6–8 controlled sweeps", cues: ["Keep ribs down", "Sweep from thighs to overhead without forcing"], regression: "Use a smaller pain-free overhead range.", media: media("loop", "audit", "Down-to-overhead shoulder sweep with quiet ribs and no cropped hands.", { src: gif("warmup_shoulder_sweep"), motion: "shoulder-cars" }) },
